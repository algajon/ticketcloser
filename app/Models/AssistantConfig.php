    ...
    public static function modelOptions(): array
    {
        return [
            [
                ...
                'costLabel' => 'Model cost: lowest',
                'qualityLabel' => 'Best low-cost default',
                'costDetail' => 'Lowest LLM spend. Voice provider cost still applies.',
            ...
            [
                ...
                'costLabel' => 'Model cost: low-medium',
                'qualityLabel' => 'Sharper follow-through',
                'costDetail' => 'More LLM spend than Standard. Voice provider cost still applies.',
            ...
            [
                ...
                'label' => 'Premium',
                'headline' => 'gpt-4.1',
                'costLabel' => 'Model cost: higher',
                'qualityLabel' => 'Best non-realtime quality',
                'costDetail' => 'Higher LLM spend. Best paired with a premium TTS voice when call quality matters.',
            ...
            [
                ...
                'costLabel' => 'Realtime cost: highest',
                'qualityLabel' => 'Most natural phone feel',
                'costDetail' => 'Native speech-to-speech audio pricing. This is the premium-cost voice path.',
