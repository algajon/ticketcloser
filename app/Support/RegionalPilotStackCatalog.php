...
class RegionalPilotStackCatalog
{
    ...
    public static function voiceCatalog(): array
    {
        $voices = [
            ...
            ['voiceId' => 'aura-2-agustina-es', 'name' => 'Agustina', 'provider' => 'deepgram', 'language' => 'es-ES', 'role' => 'default', 'style' => 'Calm, clear, professional Spanish voice', 'priceMetric' => 'Aura-2: $0.030/1k chars', 'recommended' => true],
            ['voiceId' => 'aura-2-nestor-es', 'name' => 'Nestor', 'provider' => 'deepgram', 'language' => 'es-ES', 'role' => 'operator', 'style' => 'Calm, professional, clear Spanish voice', 'priceMetric' => 'Aura-2: $0.030/1k chars', 'recommended' => true],
            ['voiceId' => 'aura-2-carina-es', 'name' => 'Carina', 'provider' => 'deepgram', 'language' => 'es-ES', 'role' => 'premium', 'style' => 'Professional, energetic Spanish IVR voice', 'priceMetric' => 'Aura-2: $0.030/1k chars', 'recommended' => true],
            ['voiceId' => 'aura-2-agathe-fr', 'name' => 'Agathe', 'provider' => 'deepgram', 'language' => 'fr-FR', 'role' => 'default', 'style' => 'Charismatic, friendly French customer-service voice', 'priceMetric' => 'Aura-2: $0.030/1k chars', 'recommended' => true],
            ['voiceId' => 'aura-2-hector-fr', 'name' => 'Hector', 'provider' => 'deepgram', 'language' => 'fr-FR', 'role' => 'operator', 'style' => 'Confident, empathetic, patient French voice', 'priceMetric' => 'Aura-2: $0.030/1k chars', 'recommended' => true],
            ['voiceId' => 'aura-2-viktoria-de', 'name' => 'Viktoria', 'provider' => 'deepgram', 'language' => 'de-DE', 'role' => 'default', 'style' => 'Warm, enthusiastic German customer-service voice', 'priceMetric' => 'Aura-2: $0.030/1k chars', 'recommended' => true],
            ['voiceId' => 'aura-2-fabian-de', 'name' => 'Fabian', 'provider' => 'deepgram', 'language' => 'de-DE', 'role' => 'operator', 'style' => 'Confident, polite, professional German voice', 'priceMetric' => 'Aura-2: $0.030/1k chars', 'recommended' => true],
            ['voiceId' => 'aura-2-elara-de', 'name' => 'Elara', 'provider' => 'deepgram', 'language' => 'de-DE', 'role' => 'premium', 'style' => 'Calm, clear, patient German voice', 'priceMetric' => 'Aura-2: $0.030/1k chars', 'recommended' => true],
            ['voiceId' => 'aura-2-izanami-ja', 'name' => 'Izanami', 'provider' => 'deepgram', 'language' => 'ja-JP', 'role' => 'default', 'style' => 'Approachable, clear, professional Japanese voice', 'priceMetric' => 'Aura-2: $0.030/1k chars', 'recommended' => true],
            ['voiceId' => 'aura-2-fujin-ja', 'name' => 'Fujin', 'provider' => 'deepgram', 'language' => 'ja-JP', 'role' => 'operator', 'style' => 'Calm, confident, smooth Japanese voice', 'priceMetric' => 'Aura-2: $0.030/1k chars', 'recommended' => true],
        ];
