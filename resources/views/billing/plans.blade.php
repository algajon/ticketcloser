    ...
    <div class="space-y-6">
        <div class="tc-accent-surface rounded-[1.5rem] border px-6 py-5">
            <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div class="max-w-3xl">
                    <div class="tc-accent-text-strong tc-label-eyebrow">Usage-based pricing</div>
                ...
                <div class="relative flex h-full flex-col rounded-[1.5rem] border {{ $isPopular ? 'tc-accent-card-active bg-white' : 'border-slate-200 bg-white shadow-[0_18px_48px_-34px_rgba(15,23,42,0.18)]' }} p-6">
                    @if($isPopular)
                        <div class="absolute -top-3 left-6">
                            <span class="tc-accent-pill-solid tc-pill-mini">Recommended</span>
                        </div>
                    @endif

                    <div class="flex items-start justify-between gap-3">
                        <div>
                            <span class="tc-pill-mini {{ $badgeColors[$plan['badge_color']] ?? 'bg-slate-100 text-slate-600' }}">
                                {{ $plan['label'] }}
                            </span>
                        ...
                        @if($isCurrent)
                            <span class="tc-pill-mini border border-emerald-200 bg-emerald-50 text-emerald-700">Current</span>
                        @endif
                    </div>
                    ...
                    <div class="mt-5 space-y-3">
                        <div class="tc-meta-card flex items-center justify-between text-sm">
        ...
        <div class="grid gap-6 lg:grid-cols-[minmax(0,1.1fr)_minmax(320px,0.9fr)]">
            <div class="tc-meta-card-strong border-slate-200 bg-white shadow-[0_14px_36px_-28px_rgba(15,23,42,0.16)]">
                <div class="tc-label-eyebrow">How billing works</div>
            ...
            <div class="tc-meta-card-strong flex flex-wrap items-center justify-between gap-3 border-slate-200 bg-white shadow-[0_14px_36px_-28px_rgba(15,23,42,0.16)]">
                <div>
                    <div class="tc-label-eyebrow">Still exploring?</div>
