@php
    ...
    $mobilePageTitle = match (true) {
        ...
        str_starts_with($routeName, 'app.messaging.') => 'Messaging',
    ...
    $descriptionMap = [
        ...
        'app.messaging.index' => 'Set up SMS confirmations after booked follow-up.',
    ...
    $navGroups = [
        ...
        [
            ...
            'items' => [
                ...
                ['name' => 'Messaging', 'route' => 'app.messaging.index', 'match' => 'app.messaging.', 'params' => $workspace ? [$workspace] : [], 'workspace' => true],
    ...
    $sectionBreadcrumbUrl = match (true) {
        ...
        str_starts_with($routeName, 'app.messaging.') => $workspace ? $routeOrNull('app.messaging.index', $workspaceRouteParams) : null,
    ...
    <div class="flex min-h-screen">
        <aside
            ...
            <div class="flex items-center justify-between gap-3">
                <a href="{{ route('home') }}" class="tc-shell-brand inline-flex items-center rounded-xl px-2 py-1.5 transition" aria-label="tickIt home">
                    <span class="text-[17px] font-bold tracking-tight text-slate-950">tick<span class="tc-accent-text">It</span></span>
                </a>
            ...
            @if($workspace)
                <div class="tc-shell-workspace-card mt-4 rounded-[1.4rem] border p-4 shadow-[0_18px_45px_-32px_rgba(15,23,42,0.34)]">
