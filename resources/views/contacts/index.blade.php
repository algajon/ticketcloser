...
@section('content')
    <div class="tc-card mb-4 min-w-0 p-4 sm:p-6">
        <form method="GET" class="grid min-w-0 gap-3 md:grid-cols-3">
            ...
            <div class="flex md:col-span-3 md:justify-end">
                <button type="submit" class="tc-btn-primary w-full sm:w-auto">Apply filters</button>
            </div>
        </form>
    </div>
